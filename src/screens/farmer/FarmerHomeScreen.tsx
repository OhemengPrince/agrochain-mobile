...
const NOTIFICATION_COLOR: Record<AppNotification['type'], string> = {
  BOOKING: colors.statusGreen,
  PAYMENT: colors.accentAmber,
  BATCH: colors.statusBlue,
  SYSTEM: colors.secondaryText,
};
            ...
            {equipment.slice(0, 6).map((item, index) => (
              ...
              >
                <View style={styles.equipmentImageWrap}>
                  <Image source={EQUIPMENT_IMAGES[index % EQUIPMENT_IMAGES.length]} style={styles.equipmentImage} />
              ...
              <View key={item.id} style={styles.activityRow}>
                <View
                  style={[
                    ...
                    { backgroundColor: `${NOTIFICATION_COLOR[item.type]}1A` },
                  ]}
                >
                  <Ionicons name={NOTIFICATION_ICON[item.type]} size={18} color={NOTIFICATION_COLOR[item.type]} />
                </View>
