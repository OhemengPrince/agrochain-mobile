  ...
  const settingsSections: SettingsSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: 'bar-chart-outline', label: 'Order History', onPress: () => setOrderHistoryVisible(true) },
        { icon: 'ribbon-outline', label: 'My Certifications', onPress: () => setCertificationsVisible(true) },
        { icon: 'stats-chart-outline', label: 'Season Report', onPress: () => setSeasonReportVisible(true) },
